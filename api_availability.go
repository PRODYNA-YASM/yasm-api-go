...
func (r AvailabilityApiApiDeleteAvailabilityRequest) Execute() (Status, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return Status
func (a *AvailabilityApiService) DeleteAvailabilityExecute(r AvailabilityApiApiDeleteAvailabilityRequest) (Status, *_nethttp.Response, error) {
	var (
