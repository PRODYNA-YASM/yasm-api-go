...
func (r AvailabilityApiApiCreateAvailabilityRequest) Execute() (PersonDetails, *_nethttp.Response, error) {
...
func (a *AvailabilityApiService) CreateAvailabilityExecute(r AvailabilityApiApiCreateAvailabilityRequest) (PersonDetails, *_nethttp.Response, error) {
	var (
