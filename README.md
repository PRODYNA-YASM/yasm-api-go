...
*PDFProfileAPI* | [**GeneratePdfProfile**](docs/PDFProfileAPI.md#generatepdfprofile) | **Post** /pdf-profile | Generate a PDF profile from a Person
...
*PersonAPI* | [**GeneratePdfProfile**](docs/PersonAPI.md#generatepdfprofile) | **Post** /pdf-profile | Generate a PDF profile from a Person
