...
*PersonAPI* | [**SearchPersonsStats**](docs/PersonAPI.md#searchpersonsstats) | **Post** /persons/search/stats | Provides search stats (e.g., direct hits) across all persons, ignoring pagination.
...
*ProjectAPI* | [**SearchProjectsStats**](docs/ProjectAPI.md#searchprojectsstats) | **Post** /projects/search/stats | Provides search stats (e.g., direct hits) across all projects, ignoring pagination.
