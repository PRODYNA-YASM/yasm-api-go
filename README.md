...
*AwardAPI* | [**GetPersonsForAwardInProject**](docs/AwardAPI.md#getpersonsforawardinproject) | **Get** /projects/{projectId}/awards/{awardId}/persons | Get all persons that have won a certain award in a certain project
*AwardAPI* | [**GetProjectsOfPersonWithAward**](docs/AwardAPI.md#getprojectsofpersonwithaward) | **Get** /persons/{personId}/awards/{awardId}/projects | Get all projects where a certain award was won by a certain person
...
*PersonAPI* | [**GetPersonsForAwardInProject**](docs/PersonAPI.md#getpersonsforawardinproject) | **Get** /projects/{projectId}/awards/{awardId}/persons | Get all persons that have won a certain award in a certain project
...
*PersonAPI* | [**GetProjectsOfPersonWithAward**](docs/PersonAPI.md#getprojectsofpersonwithaward) | **Get** /persons/{personId}/awards/{awardId}/projects | Get all projects where a certain award was won by a certain person
...
*ProjectAPI* | [**GetPersonsForAwardInProject**](docs/ProjectAPI.md#getpersonsforawardinproject) | **Get** /projects/{projectId}/awards/{awardId}/persons | Get all persons that have won a certain award in a certain project
...
*ProjectAPI* | [**GetProjectsOfPersonWithAward**](docs/ProjectAPI.md#getprojectsofpersonwithaward) | **Get** /persons/{personId}/awards/{awardId}/projects | Get all projects where a certain award was won by a certain person
