...
*PDFProfileAPI* | [**GeneratePersonProfileRaw**](docs/PDFProfileAPI.md#generatepersonprofileraw) | **Post** /pdf-profile | Generate a PDF profile from a Person
...
*PersonAPI* | [**GeneratePersonProfile**](docs/PersonAPI.md#generatepersonprofile) | **Get** /persons/{personId}/pdf-profile | Generate a PDF profile from a Person, PDF generation is now done via POST /pdf-profile/
*PersonAPI* | [**GeneratePersonProfileRaw**](docs/PersonAPI.md#generatepersonprofileraw) | **Post** /pdf-profile | Generate a PDF profile from a Person
