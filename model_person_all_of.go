...
type PersonAllOf struct {
	...
	ExperienceSinceYear *float32 `json:"experienceSinceYear,omitempty"`
	OnsiteRatio *float32 `json:"onsiteRatio,omitempty"`
...
// SetExperienceSinceYear gets a reference to the given float32 and assigns it to the ExperienceSinceYear field.
...
// SetOnsiteRatio gets a reference to the given float32 and assigns it to the OnsiteRatio field.
