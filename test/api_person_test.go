...
func Test_client_PersonAPIService(t *testing.T) {
	...
	t.Run("Test PersonAPIService AddAwardToPerson", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.AddAwardToPerson(context.Background(), personId, awardId).Execute()
	...
	t.Run("Test PersonAPIService DeleteOfficeCountry", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.DeleteOfficeCountry(context.Background(), officeId, countryId).Execute()
	...
	t.Run("Test PersonAPIService GetProjectsOfPersonWithSkill", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.GetProjectsOfPersonWithSkill(context.Background(), personId, skillId).Execute()
	...
	t.Run("Test PersonAPIService ReadPersonSkillStatistics", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.ReadPersonSkillStatistics(context.Background(), personId, skillId).Execute()
	...
	t.Run("Test PersonAPIService RemoveOrganizationServiceManager", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.RemoveOrganizationServiceManager(context.Background(), organizationId, personId).Execute()
	...
	t.Run("Test PersonAPIService UpdateOrganizationServiceManager", func(t *testing.T) {
		...
		resp, httpRes, err := apiClient.PersonAPI.UpdateOrganizationServiceManager(context.Background(), organizationId, personId).Execute()
