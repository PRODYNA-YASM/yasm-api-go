...
type PersonSearch struct {
	...
	NationalityIds []string `json:"nationalityIds,omitempty"`
...
// SetMatchMode gets a reference to the given MatchMode and assigns it to the MatchMode field.
...
// GetNationalityIds returns the NationalityIds field value if set, zero value otherwise.
func (o *PersonSearch) GetNationalityIds() []string {
	if o == nil || IsNil(o.NationalityIds) {
		var ret []string
		return ret
	}
	return o.NationalityIds
}

// GetNationalityIdsOk returns a tuple with the NationalityIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PersonSearch) GetNationalityIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.NationalityIds) {
		return nil, false
	}
	return o.NationalityIds, true
}
...
// SetNationalityIds gets a reference to the given []string and assigns it to the NationalityIds field.
...
func (o PersonSearch) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.NationalityIds) {
		toSerialize["nationalityIds"] = o.NationalityIds
	}
