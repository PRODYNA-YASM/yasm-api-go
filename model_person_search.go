...
type PersonSearch struct {
	...
	IndustriesIds []string `json:"industriesIds,omitempty"`
	CertificationsIds []string `json:"certificationsIds,omitempty"`
}
...
// GetIndustriesIds returns the IndustriesIds field value if set, zero value otherwise.
func (o *PersonSearch) GetIndustriesIds() []string {
	if o == nil || IsNil(o.IndustriesIds) {
		var ret []string
		return ret
	}
	return o.IndustriesIds
}

// GetIndustriesIdsOk returns a tuple with the IndustriesIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PersonSearch) GetIndustriesIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.IndustriesIds) {
		return nil, false
	}
	return o.IndustriesIds, true
}
...
// SetIndustriesIds gets a reference to the given []string and assigns it to the IndustriesIds field.
func (o *PersonSearch) SetIndustriesIds(v []string) {
	o.IndustriesIds = v
}

// GetCertificationsIds returns the CertificationsIds field value if set, zero value otherwise.
func (o *PersonSearch) GetCertificationsIds() []string {
	if o == nil || IsNil(o.CertificationsIds) {
		var ret []string
		return ret
	}
	return o.CertificationsIds
}

// GetCertificationsIdsOk returns a tuple with the CertificationsIds field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PersonSearch) GetCertificationsIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.CertificationsIds) {
		return nil, false
	}
	return o.CertificationsIds, true
}
...
// SetCertificationsIds gets a reference to the given []string and assigns it to the CertificationsIds field.
func (o *PersonSearch) SetCertificationsIds(v []string) {
	o.CertificationsIds = v
}
...
func (o PersonSearch) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IndustriesIds) {
		toSerialize["industriesIds"] = o.IndustriesIds
	}
	if !IsNil(o.CertificationsIds) {
		toSerialize["certificationsIds"] = o.CertificationsIds
	}
