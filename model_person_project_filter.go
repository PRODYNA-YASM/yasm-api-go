...
type _PersonProjectFilter PersonProjectFilter
...
func (o *PersonProjectFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonProjectFilter := _PersonProjectFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonProjectFilter)

	if err != nil {
		return err
	}

	*o = PersonProjectFilter(varPersonProjectFilter)
