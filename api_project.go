...
func (r ProjectApiApiSearchProjectsRequest) Execute() (PagedProjects, *_nethttp.Response, error) {
...
*/
func (a *ProjectApiService) SearchProjects(ctx _context.Context) ProjectApiApiSearchProjectsRequest {
	return ProjectApiApiSearchProjectsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PagedProjects
func (a *ProjectApiService) SearchProjectsExecute(r ProjectApiApiSearchProjectsRequest) (PagedProjects, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
