...
type ProjectAPIGetPersonsForAwardInProjectRequest struct {
	ctx context.Context
	ApiService *ProjectAPIService
	projectId string
	awardId string
...
func (r ProjectAPIGetPersonsForAwardInProjectRequest) Execute() (*PagedPersons, *http.Response, error) {
...
GetPersonsForAwardInProject Get all persons that have won a certain award in a certain project
 ...
 @param projectId
 @param awardId
 @return ProjectAPIGetPersonsForAwardInProjectRequest
*/
func (a *ProjectAPIService) GetPersonsForAwardInProject(ctx context.Context, projectId string, awardId string) ProjectAPIGetPersonsForAwardInProjectRequest {
	return ProjectAPIGetPersonsForAwardInProjectRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return PagedPersons
func (a *ProjectAPIService) GetPersonsForAwardInProjectExecute(r ProjectAPIGetPersonsForAwardInProjectRequest) (*PagedPersons, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.GetPersonsForAwardInProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ProjectAPIGetProjectsOfPersonWithAwardRequest struct {
	ctx context.Context
	ApiService *ProjectAPIService
	personId string
	awardId string
...
func (r ProjectAPIGetProjectsOfPersonWithAwardRequest) Execute() (*PagedProjects, *http.Response, error) {
...
GetProjectsOfPersonWithAward Get all projects where a certain award was won by a certain person
 ...
 @param personId
 @param awardId
 @return ProjectAPIGetProjectsOfPersonWithAwardRequest
*/
func (a *ProjectAPIService) GetProjectsOfPersonWithAward(ctx context.Context, personId string, awardId string) ProjectAPIGetProjectsOfPersonWithAwardRequest {
	return ProjectAPIGetProjectsOfPersonWithAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *ProjectAPIService) GetProjectsOfPersonWithAwardExecute(r ProjectAPIGetProjectsOfPersonWithAwardRequest) (*PagedProjects, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ProjectAPIService.GetProjectsOfPersonWithAward")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
