...
func (r IndustryApiApiCreateIndustryRequest) Execute() (*IndustryDetails, *http.Response, error) {
...
func (a *IndustryApiService) CreateIndustryExecute(r IndustryApiApiCreateIndustryRequest) (*IndustryDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r IndustryApiApiUpdateIndustryRequest) Execute() (*IndustryDetails, *http.Response, error) {
...
// Execute executes the request
//  @return IndustryDetails
func (a *IndustryApiService) UpdateIndustryExecute(r IndustryApiApiUpdateIndustryRequest) (*IndustryDetails, *http.Response, error) {
	var (
