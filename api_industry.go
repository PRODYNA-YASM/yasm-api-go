...
type IndustryApiSearchAllIndustriesRequest struct {
	ctx context.Context
	ApiService *IndustryApiService
	text string
	skip *int32
...
func (r IndustryApiSearchAllIndustriesRequest) Skip(skip int32) IndustryApiSearchAllIndustriesRequest {
	r.skip = &skip
	return r
}

func (r IndustryApiSearchAllIndustriesRequest) Limit(limit int32) IndustryApiSearchAllIndustriesRequest {
	r.limit = &limit
	return r
}

func (r IndustryApiSearchAllIndustriesRequest) Execute() (*PagedIndustries, *http.Response, error) {
	return r.ApiService.SearchAllIndustriesExecute(r)
}

/*
SearchAllIndustries Fulltext search on all industries

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param text
 @return IndustryApiSearchAllIndustriesRequest
*/
func (a *IndustryApiService) SearchAllIndustries(ctx context.Context, text string) IndustryApiSearchAllIndustriesRequest {
	return IndustryApiSearchAllIndustriesRequest{
		ApiService: a,
		ctx: ctx,
		text: text,
...
// Execute executes the request
//  @return PagedIndustries
func (a *IndustryApiService) SearchAllIndustriesExecute(r IndustryApiSearchAllIndustriesRequest) (*PagedIndustries, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IndustryApiService.SearchAllIndustries")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/industries/search/{text}"
