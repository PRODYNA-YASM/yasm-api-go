...
func (o PersonIndustryFilter) MarshalJSON() ([]byte, error) {
	...
	serializedEntityFilter, errEntityFilter := json.Marshal(o.EntityFilter)
	if errEntityFilter != nil {
		return []byte{}, errEntityFilter
	}
	errEntityFilter = json.Unmarshal([]byte(serializedEntityFilter), &toSerialize)
	if errEntityFilter != nil {
		return []byte{}, errEntityFilter
	}
