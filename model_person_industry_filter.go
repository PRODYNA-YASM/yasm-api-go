...
type _PersonIndustryFilter PersonIndustryFilter
...
func (o *PersonIndustryFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonIndustryFilter := _PersonIndustryFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonIndustryFilter)

	if err != nil {
		return err
	}

	*o = PersonIndustryFilter(varPersonIndustryFilter)
