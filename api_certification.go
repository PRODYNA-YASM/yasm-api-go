...
func (r CertificationApiApiAddPersonCertificationRequest) Date(date Date) CertificationApiApiAddPersonCertificationRequest {
	r.date = &date
	return r
}
...
func (r CertificationApiApiDeletePersonCertificationRequest) Execute() (Status, *_nethttp.Response, error) {
 ...
 * @return Status
 */
func (a *CertificationApiService) DeletePersonCertificationExecute(r CertificationApiApiDeletePersonCertificationRequest) (Status, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r CertificationApiApiUpdatePersonCertificationRequest) Date(date Date) CertificationApiApiUpdatePersonCertificationRequest {
	r.date = &date
	return r
}
