...
func (r OfficeAPICreateOfficeRequest) OrganizationId(organizationId string) OfficeAPICreateOfficeRequest {
...
func (r OfficeAPICreateOfficeRequest) Execute() (*Office, *http.Response, error) {
...
// Execute executes the request
//  @return Office
func (a *OfficeAPIService) CreateOfficeExecute(r OfficeAPICreateOfficeRequest) (*Office, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
