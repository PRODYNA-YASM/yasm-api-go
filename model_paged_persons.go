...
func (o PagedPersons) ToMap() (map[string]interface{}, error) {
	...
	serializedPageWithDirectHitCount, errPageWithDirectHitCount := json.Marshal(o.PageWithDirectHitCount)
	if errPageWithDirectHitCount != nil {
		return map[string]interface{}{}, errPageWithDirectHitCount
	}
	errPageWithDirectHitCount = json.Unmarshal([]byte(serializedPageWithDirectHitCount), &toSerialize)
	if errPageWithDirectHitCount != nil {
		return map[string]interface{}{}, errPageWithDirectHitCount
	}
	if !IsNil(o.Persons) {
