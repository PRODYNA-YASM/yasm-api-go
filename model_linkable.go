...
// checks if the Linkable type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Linkable{}
...
func (o Linkable) ToMap() (map[string]interface{}, error) {
