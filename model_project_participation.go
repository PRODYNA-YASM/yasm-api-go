...
type _ProjectParticipation ProjectParticipation
...
func (o *ProjectParticipation) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectParticipation := _ProjectParticipation{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProjectParticipation)

	if err != nil {
		return err
	}

	*o = ProjectParticipation(varProjectParticipation)
