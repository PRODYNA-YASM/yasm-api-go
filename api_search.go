...
func (r SearchApiApiSearchAllRequest) Execute() (*SearchResult, *http.Response, error) {
...
*/
func (a *SearchApiService) SearchAll(ctx context.Context, text string) SearchApiApiSearchAllRequest {
	return SearchApiApiSearchAllRequest{
		ApiService: a,
		ctx: ctx,
		text: text,
...
//  @return SearchResult
func (a *SearchApiService) SearchAllExecute(r SearchApiApiSearchAllRequest) (*SearchResult, *http.Response, error) {
	var (
