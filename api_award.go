...
type AwardAPIGetPersonsForAwardInProjectRequest struct {
	ctx context.Context
	ApiService *AwardAPIService
	projectId string
	awardId string
...
func (r AwardAPIGetPersonsForAwardInProjectRequest) Execute() (*PagedPersons, *http.Response, error) {
...
GetPersonsForAwardInProject Get all persons that have won a certain award in a certain project
 ...
 @param projectId
 @param awardId
 @return AwardAPIGetPersonsForAwardInProjectRequest
*/
func (a *AwardAPIService) GetPersonsForAwardInProject(ctx context.Context, projectId string, awardId string) AwardAPIGetPersonsForAwardInProjectRequest {
	return AwardAPIGetPersonsForAwardInProjectRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return PagedPersons
func (a *AwardAPIService) GetPersonsForAwardInProjectExecute(r AwardAPIGetPersonsForAwardInProjectRequest) (*PagedPersons, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AwardAPIService.GetPersonsForAwardInProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type AwardAPIGetProjectsOfPersonWithAwardRequest struct {
	ctx context.Context
	ApiService *AwardAPIService
	personId string
	awardId string
...
func (r AwardAPIGetProjectsOfPersonWithAwardRequest) Execute() (*PagedProjects, *http.Response, error) {
...
GetProjectsOfPersonWithAward Get all projects where a certain award was won by a certain person
 ...
 @param personId
 @param awardId
 @return AwardAPIGetProjectsOfPersonWithAwardRequest
*/
func (a *AwardAPIService) GetProjectsOfPersonWithAward(ctx context.Context, personId string, awardId string) AwardAPIGetProjectsOfPersonWithAwardRequest {
	return AwardAPIGetProjectsOfPersonWithAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *AwardAPIService) GetProjectsOfPersonWithAwardExecute(r AwardAPIGetProjectsOfPersonWithAwardRequest) (*PagedProjects, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "AwardAPIService.GetProjectsOfPersonWithAward")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
