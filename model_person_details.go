...
type PersonDetails struct {
	...
	Nationalities []Country `json:"nationalities,omitempty"`
	Office *OfficeDetails `json:"office,omitempty"`
	...
	TeamMembers []Person `json:"teamMembers,omitempty"`
...
// SetNationalities gets a reference to the given []Country and assigns it to the Nationalities field.
...
// SetOffice gets a reference to the given OfficeDetails and assigns it to the Office field.
...
// SetTeamMembers gets a reference to the given []Person and assigns it to the TeamMembers field.
