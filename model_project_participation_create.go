...
type _ProjectParticipationCreate ProjectParticipationCreate
...
func (o *ProjectParticipationCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varProjectParticipationCreate := _ProjectParticipationCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varProjectParticipationCreate)

	if err != nil {
		return err
	}

	*o = ProjectParticipationCreate(varProjectParticipationCreate)
