...
type _EntityFilter EntityFilter
...
func (o *EntityFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varEntityFilter := _EntityFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEntityFilter)

	if err != nil {
		return err
	}

	*o = EntityFilter(varEntityFilter)
