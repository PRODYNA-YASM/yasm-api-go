...
// GetSkillLevelOk returns a tuple with the SkillLevel field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Experience) GetSkillLevelOk() (*SkillLevel, bool) {
	if o == nil || IsNil(o.SkillLevel) {
		return nil, false
	}
	return o.SkillLevel, true
}
...
// SetSkillLevel gets a reference to the given SkillLevel and assigns it to the SkillLevel field.
...
func (o Experience) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SkillLevel) {
		toSerialize["skillLevel"] = o.SkillLevel
	}
	if !IsNil(o.ConfirmedBy) {
