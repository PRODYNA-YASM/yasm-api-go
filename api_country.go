...
type CountryApiApiAddLangaugeToCountryRequest struct {
...
func (r CountryApiApiAddLangaugeToCountryRequest) Execute() (CountryDetails, *_nethttp.Response, error) {
 ...
 * @param countryId
 * @param languageId
 * @return CountryApiApiAddLangaugeToCountryRequest
 */
func (a *CountryApiService) AddLangaugeToCountry(ctx _context.Context, countryId string, languageId string) CountryApiApiAddLangaugeToCountryRequest {
	return CountryApiApiAddLangaugeToCountryRequest{
		ApiService: a,
		ctx: ctx,
		countryId: countryId,
 ...
 */
func (a *CountryApiService) AddLangaugeToCountryExecute(r CountryApiApiAddLangaugeToCountryRequest) (CountryDetails, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountryApiService.AddLangaugeToCountry")
	if err != nil {
