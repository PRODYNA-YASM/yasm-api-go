...
type CountryAPIUpdateOfficeCountryRequest struct {
	ctx context.Context
	ApiService *CountryAPIService
	officeId string
	countryId string
...
func (r CountryAPIUpdateOfficeCountryRequest) Execute() (*OfficeDetails, *http.Response, error) {
...
UpdateOfficeCountry Assign a country to an office
 ...
 @param officeId
 @param countryId
 @return CountryAPIUpdateOfficeCountryRequest
*/
func (a *CountryAPIService) UpdateOfficeCountry(ctx context.Context, officeId string, countryId string) CountryAPIUpdateOfficeCountryRequest {
	return CountryAPIUpdateOfficeCountryRequest{
		ApiService: a,
		ctx: ctx,
		officeId: officeId,
...
func (a *CountryAPIService) UpdateOfficeCountryExecute(r CountryAPIUpdateOfficeCountryRequest) (*OfficeDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CountryAPIService.UpdateOfficeCountry")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
