...
type Person struct {
	...
	EmployeeSince *string `json:"employeeSince,omitempty"`
	...
	// Indicates if the person is a former employee
	FormerEmployee *bool `json:"formerEmployee,omitempty"`
}
...
// GetEmployeeSince returns the EmployeeSince field value if set, zero value otherwise.
func (o *Person) GetEmployeeSince() string {
	if o == nil || IsNil(o.EmployeeSince) {
		var ret string
		return ret
	}
	return *o.EmployeeSince
}

// GetEmployeeSinceOk returns a tuple with the EmployeeSince field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Person) GetEmployeeSinceOk() (*string, bool) {
	if o == nil || IsNil(o.EmployeeSince) {
		return nil, false
	}
	return o.EmployeeSince, true
}
...
// SetEmployeeSince gets a reference to the given string and assigns it to the EmployeeSince field.
...
// GetFormerEmployee returns the FormerEmployee field value if set, zero value otherwise.
func (o *Person) GetFormerEmployee() bool {
	if o == nil || IsNil(o.FormerEmployee) {
		var ret bool
		return ret
	}
	return *o.FormerEmployee
}

// GetFormerEmployeeOk returns a tuple with the FormerEmployee field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Person) GetFormerEmployeeOk() (*bool, bool) {
	if o == nil || IsNil(o.FormerEmployee) {
		return nil, false
	}
	return o.FormerEmployee, true
}
...
// SetFormerEmployee gets a reference to the given bool and assigns it to the FormerEmployee field.
...
func (o Person) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.EmployeeSince) {
		toSerialize["employeeSince"] = o.EmployeeSince
	}
	...
	if !IsNil(o.FormerEmployee) {
		toSerialize["formerEmployee"] = o.FormerEmployee
	}
