...
type _PersonSkillFilter PersonSkillFilter
...
func (o *PersonSkillFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonSkillFilter := _PersonSkillFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonSkillFilter)

	if err != nil {
		return err
	}

	*o = PersonSkillFilter(varPersonSkillFilter)
