...
// checks if the LanguageLevel type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LanguageLevel{}
...
func (o LanguageLevel) ToMap() (map[string]interface{}, error) {
