...
type _PersonOrganizationFilter PersonOrganizationFilter
...
func (o *PersonOrganizationFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonOrganizationFilter := _PersonOrganizationFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonOrganizationFilter)

	if err != nil {
		return err
	}

	*o = PersonOrganizationFilter(varPersonOrganizationFilter)
