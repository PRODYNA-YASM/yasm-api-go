...
type _BasicDomainModel BasicDomainModel
...
func (o *BasicDomainModel) UnmarshalJSON(data []byte) (err error) {
	...
	varBasicDomainModel := _BasicDomainModel{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBasicDomainModel)

	if err != nil {
		return err
	}

	*o = BasicDomainModel(varBasicDomainModel)
