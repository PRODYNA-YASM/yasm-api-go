...
type _PersonCertificationFilter PersonCertificationFilter
...
func (o *PersonCertificationFilter) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonCertificationFilter := _PersonCertificationFilter{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonCertificationFilter)

	if err != nil {
		return err
	}

	*o = PersonCertificationFilter(varPersonCertificationFilter)
