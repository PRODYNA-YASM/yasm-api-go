...
type LanguageApiApiAddLangaugeToCountryRequest struct {
...
func (r LanguageApiApiAddLangaugeToCountryRequest) Execute() (CountryDetails, *_nethttp.Response, error) {
 ...
 * @param countryId
 * @param languageId
 * @return LanguageApiApiAddLangaugeToCountryRequest
 */
func (a *LanguageApiService) AddLangaugeToCountry(ctx _context.Context, countryId string, languageId string) LanguageApiApiAddLangaugeToCountryRequest {
	return LanguageApiApiAddLangaugeToCountryRequest{
		ApiService: a,
		ctx: ctx,
		countryId: countryId,
 ...
 */
func (a *LanguageApiService) AddLangaugeToCountryExecute(r LanguageApiApiAddLangaugeToCountryRequest) (CountryDetails, *_nethttp.Response, error) {
	var (
