...
type PersonAPIGeneratePdfProfileRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	profileRequest *ProfileRequest
}

func (r PersonAPIGeneratePdfProfileRequest) ProfileRequest(profileRequest ProfileRequest) PersonAPIGeneratePdfProfileRequest {
	r.profileRequest = &profileRequest
	return r
}

func (r PersonAPIGeneratePdfProfileRequest) Execute() (*os.File, *http.Response, error) {
...
GeneratePdfProfile Generate a PDF profile from a Person
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PersonAPIGeneratePdfProfileRequest
*/
func (a *PersonAPIService) GeneratePdfProfile(ctx context.Context) PersonAPIGeneratePdfProfileRequest {
	return PersonAPIGeneratePdfProfileRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return *os.File
func (a *PersonAPIService) GeneratePdfProfileExecute(r PersonAPIGeneratePdfProfileRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.GeneratePdfProfile")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
