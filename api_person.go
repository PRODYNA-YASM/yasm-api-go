...
type PersonAPIAddPersonAwardRequest struct {
	ctx context.Context
...
func (r PersonAPIAddPersonAwardRequest) Body(body string) PersonAPIAddPersonAwardRequest {
	r.body = &body
	return r
}

func (r PersonAPIAddPersonAwardRequest) Execute() (*PersonDetails, *http.Response, error) {
...
AddPersonAward Add an award to a Person
 ...
 @param personId
 @param awardId
 @return PersonAPIAddPersonAwardRequest
*/
func (a *PersonAPIService) AddPersonAward(ctx context.Context, personId string, awardId string) PersonAPIAddPersonAwardRequest {
	return PersonAPIAddPersonAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *PersonAPIService) AddPersonAwardExecute(r PersonAPIAddPersonAwardRequest) (*PersonDetails, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.AddPersonAward")
	if err != nil {
...
type PersonAPIUpdatePersonAwardRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	personId string
	awardId string
...
func (r PersonAPIUpdatePersonAwardRequest) Body(body string) PersonAPIUpdatePersonAwardRequest {
	r.body = &body
	return r
}

func (r PersonAPIUpdatePersonAwardRequest) Execute() (*PersonDetails, *http.Response, error) {
...
UpdatePersonAward Update an Award of a Person
 ...
 @param personId
 @param awardId
 @return PersonAPIUpdatePersonAwardRequest
*/
func (a *PersonAPIService) UpdatePersonAward(ctx context.Context, personId string, awardId string) PersonAPIUpdatePersonAwardRequest {
	return PersonAPIUpdatePersonAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonAPIService) UpdatePersonAwardExecute(r PersonAPIUpdatePersonAwardRequest) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.UpdatePersonAward")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
