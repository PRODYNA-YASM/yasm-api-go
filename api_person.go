...
func (r PersonApiApiDeleteAvailabilityRequest) Execute() (AvailabilityDetail, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return AvailabilityDetail
func (a *PersonApiService) DeleteAvailabilityExecute(r PersonApiApiDeleteAvailabilityRequest) (AvailabilityDetail, *_nethttp.Response, error) {
	var (
