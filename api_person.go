...
func (r PersonApiApiCreateAvailabilityRequest) Execute() (PersonDetails, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonApiService) CreateAvailabilityExecute(r PersonApiApiCreateAvailabilityRequest) (PersonDetails, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
