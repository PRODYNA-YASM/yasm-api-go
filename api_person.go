...
/*
GeneratePersonProfile Generate a PDF profile from a Person, PDF generation is now done via POST /pdf-profile/
...
type PersonAPIGeneratePersonProfileRawRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	profileRequest *ProfileRequest
}

func (r PersonAPIGeneratePersonProfileRawRequest) ProfileRequest(profileRequest ProfileRequest) PersonAPIGeneratePersonProfileRawRequest {
	r.profileRequest = &profileRequest
	return r
}

func (r PersonAPIGeneratePersonProfileRawRequest) Execute() (*os.File, *http.Response, error) {
...
GeneratePersonProfileRaw Generate a PDF profile from a Person
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PersonAPIGeneratePersonProfileRawRequest
*/
func (a *PersonAPIService) GeneratePersonProfileRaw(ctx context.Context) PersonAPIGeneratePersonProfileRawRequest {
	return PersonAPIGeneratePersonProfileRawRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return *os.File
func (a *PersonAPIService) GeneratePersonProfileRawExecute(r PersonAPIGeneratePersonProfileRawRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.GeneratePersonProfileRaw")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
