...
func (a *PersonAPIService) GeneratePersonProfileExecute(r PersonAPIGeneratePersonProfileRequest) (*os.File, *http.Response, error) {
	...
	if r.projectIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "projectIds", r.projectIds, "csv")
	}
	if r.skillIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "skillIds", r.skillIds, "csv")
	}
	if r.certificationIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "certificationIds", r.certificationIds, "csv")
	}
	if r.profileIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "profileIds", r.profileIds, "csv")
	}
	if r.seniority != nil {
