...
type PersonAPISearchPersonsStatsRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	personSearch *PersonSearch
}

func (r PersonAPISearchPersonsStatsRequest) PersonSearch(personSearch PersonSearch) PersonAPISearchPersonsStatsRequest {
	r.personSearch = &personSearch
	return r
}

func (r PersonAPISearchPersonsStatsRequest) Execute() (*SearchStats, *http.Response, error) {
	return r.ApiService.SearchPersonsStatsExecute(r)
}

/*
SearchPersonsStats Provides search stats (e.g., direct hits) across all persons, ignoring pagination.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PersonAPISearchPersonsStatsRequest
*/
func (a *PersonAPIService) SearchPersonsStats(ctx context.Context) PersonAPISearchPersonsStatsRequest {
	return PersonAPISearchPersonsStatsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SearchStats
func (a *PersonAPIService) SearchPersonsStatsExecute(r PersonAPISearchPersonsStatsRequest) (*SearchStats, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.SearchPersonsStats")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/persons/search/stats"
