...
func (r PersonApiApiDeletePersonRequest) Execute() (PersonDetails, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonApiService) DeletePersonExecute(r PersonApiApiDeletePersonRequest) (PersonDetails, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
