...
type PersonAPIGetPersonsForAwardInProjectRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	projectId string
	awardId string
...
func (r PersonAPIGetPersonsForAwardInProjectRequest) Execute() (*PagedPersons, *http.Response, error) {
	return r.ApiService.GetPersonsForAwardInProjectExecute(r)
}

/*
GetPersonsForAwardInProject Get all persons that have won a certain award in a certain project

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param projectId
 @param awardId
 @return PersonAPIGetPersonsForAwardInProjectRequest
*/
func (a *PersonAPIService) GetPersonsForAwardInProject(ctx context.Context, projectId string, awardId string) PersonAPIGetPersonsForAwardInProjectRequest {
	return PersonAPIGetPersonsForAwardInProjectRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return PagedPersons
func (a *PersonAPIService) GetPersonsForAwardInProjectExecute(r PersonAPIGetPersonsForAwardInProjectRequest) (*PagedPersons, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.GetPersonsForAwardInProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/projects/{projectId}/awards/{awardId}/persons"
...
type PersonAPIGetProjectsOfPersonWithAwardRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	personId string
	awardId string
...
func (r PersonAPIGetProjectsOfPersonWithAwardRequest) Execute() (*PagedProjects, *http.Response, error) {
	return r.ApiService.GetProjectsOfPersonWithAwardExecute(r)
}

/*
GetProjectsOfPersonWithAward Get all projects where a certain award was won by a certain person

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param personId
 @param awardId
 @return PersonAPIGetProjectsOfPersonWithAwardRequest
*/
func (a *PersonAPIService) GetProjectsOfPersonWithAward(ctx context.Context, personId string, awardId string) PersonAPIGetProjectsOfPersonWithAwardRequest {
	return PersonAPIGetProjectsOfPersonWithAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *PersonAPIService) GetProjectsOfPersonWithAwardExecute(r PersonAPIGetProjectsOfPersonWithAwardRequest) (*PagedProjects, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.GetProjectsOfPersonWithAward")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/persons/{personId}/awards/{awardId}/projects"
	localVarPath = strings.Replace(localVarPath, "{"+"personId"+"}", url.PathEscape(parameterValueToString(r.personId, "personId")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"awardId"+"}", url.PathEscape(parameterValueToString(r.awardId, "awardId")), -1)
