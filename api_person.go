...
type PersonApiApiAddPersonLanguageRequest struct {
	ctx context.Context
	ApiService *PersonApiService
	personId string
	languageId string
...
func (r PersonApiApiAddPersonLanguageRequest) Level(level Level) PersonApiApiAddPersonLanguageRequest {
	r.level = &level
	return r
}

func (r PersonApiApiAddPersonLanguageRequest) Execute() (*PersonDetails, *http.Response, error) {
...
AddPersonLanguage Assign a language to the person
 ...
 @param personId
 @param languageId
 @return PersonApiApiAddPersonLanguageRequest
*/
func (a *PersonApiService) AddPersonLanguage(ctx context.Context, personId string, languageId string) PersonApiApiAddPersonLanguageRequest {
	return PersonApiApiAddPersonLanguageRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonApiService) AddPersonLanguageExecute(r PersonApiApiAddPersonLanguageRequest) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
type PersonApiApiRemovePersonLanguageRequest struct {
	ctx context.Context
	ApiService *PersonApiService
	personId string
	languageId string
...
func (r PersonApiApiRemovePersonLanguageRequest) Execute() (*PersonDetails, *http.Response, error) {
...
*/
func (a *PersonApiService) RemovePersonLanguage(ctx context.Context, personId string, languageId string) PersonApiApiRemovePersonLanguageRequest {
	return PersonApiApiRemovePersonLanguageRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonApiService) RemovePersonLanguageExecute(r PersonApiApiRemovePersonLanguageRequest) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
...
type PersonApiApiUupdatePersonLanguageRequest struct {
	ctx context.Context
	ApiService *PersonApiService
	personId string
	languageId string
...
func (r PersonApiApiUupdatePersonLanguageRequest) Level(level Level) PersonApiApiUupdatePersonLanguageRequest {
	r.level = &level
	return r
}

func (r PersonApiApiUupdatePersonLanguageRequest) Execute() (*PersonDetails, *http.Response, error) {
...
UupdatePersonLanguage Update a language of a person
 ...
 @param personId
 @param languageId
 @return PersonApiApiUupdatePersonLanguageRequest
*/
func (a *PersonApiService) UupdatePersonLanguage(ctx context.Context, personId string, languageId string) PersonApiApiUupdatePersonLanguageRequest {
	return PersonApiApiUupdatePersonLanguageRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonApiService) UupdatePersonLanguageExecute(r PersonApiApiUupdatePersonLanguageRequest) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
