...
func (r PersonAPIDeletePersonOfficeRequest) Execute() (*OfficeDetails, *http.Response, error) {
...
*/
func (a *PersonAPIService) DeletePersonOffice(ctx context.Context, officeId string, countryId string) PersonAPIDeletePersonOfficeRequest {
	return PersonAPIDeletePersonOfficeRequest{
		ApiService: a,
		ctx: ctx,
		officeId: officeId,
...
func (a *PersonAPIService) DeletePersonOfficeExecute(r PersonAPIDeletePersonOfficeRequest) (*OfficeDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
...
type PersonAPIDeletePersonOffice_0Request struct {
	ctx context.Context
	ApiService *PersonAPIService
	personId string
	officeId string
...
func (r PersonAPIDeletePersonOffice_0Request) Execute() (*PersonDetails, *http.Response, error) {
	return r.ApiService.DeletePersonOffice_1Execute(r)
}

/*
DeletePersonOffice_0 Delete the office from a Person

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param personId
 @param officeId
 @return PersonAPIDeletePersonOffice_0Request
*/
func (a *PersonAPIService) DeletePersonOffice_1(ctx context.Context, personId string, officeId string) PersonAPIDeletePersonOffice_0Request {
	return PersonAPIDeletePersonOffice_0Request{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonAPIService) DeletePersonOffice_1Execute(r PersonAPIDeletePersonOffice_0Request) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.DeletePersonOffice_1")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
