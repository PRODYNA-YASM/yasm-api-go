...
type PersonAPIAddAwardToPersonRequest struct {
	ctx context.Context
...
func (r PersonAPIAddAwardToPersonRequest) Execute() (*PersonDetails, *http.Response, error) {
...
AddAwardToPerson Add award to person
 ...
 @param personId
 @param awardId
 @return PersonAPIAddAwardToPersonRequest
*/
func (a *PersonAPIService) AddAwardToPerson(ctx context.Context, personId string, awardId string) PersonAPIAddAwardToPersonRequest {
	return PersonAPIAddAwardToPersonRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *PersonAPIService) AddAwardToPersonExecute(r PersonAPIAddAwardToPersonRequest) (*PersonDetails, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.AddAwardToPerson")
	if err != nil {
...
type PersonAPIBulkCreatePdfProfilesRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	profileRequests *ProfileRequests
}

func (r PersonAPIBulkCreatePdfProfilesRequest) ProfileRequests(profileRequests ProfileRequests) PersonAPIBulkCreatePdfProfilesRequest {
	r.profileRequests = &profileRequests
	return r
}

func (r PersonAPIBulkCreatePdfProfilesRequest) Execute() (*os.File, *http.Response, error) {
...
BulkCreatePdfProfiles Generate PDF profiles wrapped in a ZIP File from a list of Persons
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return PersonAPIBulkCreatePdfProfilesRequest
*/
func (a *PersonAPIService) BulkCreatePdfProfiles(ctx context.Context) PersonAPIBulkCreatePdfProfilesRequest {
	return PersonAPIBulkCreatePdfProfilesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return *os.File
func (a *PersonAPIService) BulkCreatePdfProfilesExecute(r PersonAPIBulkCreatePdfProfilesRequest) (*os.File, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.BulkCreatePdfProfiles")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type PersonAPIDeletePersonAwardRequest struct {
	ctx context.Context
	ApiService *PersonAPIService
	personId string
	awardId string
...
func (r PersonAPIDeletePersonAwardRequest) Execute() (*PersonDetails, *http.Response, error) {
...
DeletePersonAward Remove Award from a Person
 ...
 @param personId
 @param awardId
 @return PersonAPIDeletePersonAwardRequest
*/
func (a *PersonAPIService) DeletePersonAward(ctx context.Context, personId string, awardId string) PersonAPIDeletePersonAwardRequest {
	return PersonAPIDeletePersonAwardRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
// Execute executes the request
//  @return PersonDetails
func (a *PersonAPIService) DeletePersonAwardExecute(r PersonAPIDeletePersonAwardRequest) (*PersonDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PersonAPIService.DeletePersonAward")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
