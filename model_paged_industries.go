...
type PagedIndustries struct {
	...
	Industries []IndutryDetails `json:"industries,omitempty"`
}
...
// SetIndustries gets a reference to the given []IndutryDetails and assigns it to the Industries field.
