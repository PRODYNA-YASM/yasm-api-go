...
func (o *Suggestable) UnmarshalJSON(data []byte) (err error) {
	...
	varSuggestable := _Suggestable{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSuggestable)

	if err != nil {
		return err
	}

	*o = Suggestable(varSuggestable)
