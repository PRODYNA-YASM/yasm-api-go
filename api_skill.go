...
type SkillApiSearchAllSkillsRequest struct {
	ctx context.Context
	ApiService *SkillApiService
	text string
	skip *int32
...
func (r SkillApiSearchAllSkillsRequest) Skip(skip int32) SkillApiSearchAllSkillsRequest {
	r.skip = &skip
	return r
}

func (r SkillApiSearchAllSkillsRequest) Limit(limit int32) SkillApiSearchAllSkillsRequest {
	r.limit = &limit
	return r
}

func (r SkillApiSearchAllSkillsRequest) Execute() (*PagedSkills, *http.Response, error) {
	return r.ApiService.SearchAllSkillsExecute(r)
}

/*
SearchAllSkills Fulltext search on all skills

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param text
 @return SkillApiSearchAllSkillsRequest
*/
func (a *SkillApiService) SearchAllSkills(ctx context.Context, text string) SkillApiSearchAllSkillsRequest {
	return SkillApiSearchAllSkillsRequest{
		ApiService: a,
		ctx: ctx,
		text: text,
...
// Execute executes the request
//  @return PagedSkills
func (a *SkillApiService) SearchAllSkillsExecute(r SkillApiSearchAllSkillsRequest) (*PagedSkills, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillApiService.SearchAllSkills")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/skills/search/{text}"
