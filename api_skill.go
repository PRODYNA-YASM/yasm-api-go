...
func (r SkillApiApiAddPersonInterestRequest) Person(person Person) SkillApiApiAddPersonInterestRequest {
	r.person = &person
	return r
}
...
func (r SkillApiApiDeleteConfirmationRequest) Execute() (Status, *_nethttp.Response, error) {
 ...
 * @return Status
 */
func (a *SkillApiService) DeleteConfirmationExecute(r SkillApiApiDeleteConfirmationRequest) (Status, *_nethttp.Response, error) {
	var (
...
func (r SkillApiApiDeletePersonInterestRequest) Execute() (Status, *_nethttp.Response, error) {
 ...
 * @return Status
 */
func (a *SkillApiService) DeletePersonInterestExecute(r SkillApiApiDeletePersonInterestRequest) (Status, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodDelete
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r SkillApiApiGetSkillsRequest) RootOnly(rootOnly bool) SkillApiApiGetSkillsRequest {
	r.rootOnly = &rootOnly
	return r
}
