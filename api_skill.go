...
type SkillAPIAddSkillConfirmationRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
...
func (r SkillAPIAddSkillConfirmationRequest) Execute() (*ProjectParticipationDetails, *http.Response, error) {
...
AddSkillConfirmation Confirm Skill
 ...
 @return SkillAPIAddSkillConfirmationRequest
*/
func (a *SkillAPIService) AddSkillConfirmation(ctx context.Context, projectParticipationId string, skillId string, confirmingPersonId string) SkillAPIAddSkillConfirmationRequest {
	return SkillAPIAddSkillConfirmationRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *SkillAPIService) AddSkillConfirmationExecute(r SkillAPIAddSkillConfirmationRequest) (*ProjectParticipationDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.AddSkillConfirmation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r SkillAPIAddSkillToParentSkillRequest) SkillLinkUpdate(skillLinkUpdate SkillLinkUpdate) SkillAPIAddSkillToParentSkillRequest {
	r.skillLinkUpdate = &skillLinkUpdate
	return r
}
...
func (a *SkillAPIService) AddSkillToParentSkillExecute(r SkillAPIAddSkillToParentSkillRequest) (*SkillDetails, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.skillLinkUpdate == nil {
		return localVarReturnValue, nil, reportError("skillLinkUpdate is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.skillLinkUpdate
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type SkillAPIGetPersonsForSkillInProjectRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
	projectId string
	skillId string
...
func (r SkillAPIGetPersonsForSkillInProjectRequest) Execute() (*PagedPersons, *http.Response, error) {
...
GetPersonsForSkillInProject Get all persons that use a certain skill in a certain project
 ...
 @param projectId
 @param skillId
 @return SkillAPIGetPersonsForSkillInProjectRequest
*/
func (a *SkillAPIService) GetPersonsForSkillInProject(ctx context.Context, projectId string, skillId string) SkillAPIGetPersonsForSkillInProjectRequest {
	return SkillAPIGetPersonsForSkillInProjectRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return PagedPersons
func (a *SkillAPIService) GetPersonsForSkillInProjectExecute(r SkillAPIGetPersonsForSkillInProjectRequest) (*PagedPersons, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.GetPersonsForSkillInProject")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type SkillAPIGetProjectsOfPersonWithSkillRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
	personId string
	skillId string
...
func (r SkillAPIGetProjectsOfPersonWithSkillRequest) Execute() (*PagedProjects, *http.Response, error) {
...
GetProjectsOfPersonWithSkill Get all projects where a certain skill was used by a certain person
 ...
 @param personId
 @param skillId
 @return SkillAPIGetProjectsOfPersonWithSkillRequest
*/
func (a *SkillAPIService) GetProjectsOfPersonWithSkill(ctx context.Context, personId string, skillId string) SkillAPIGetProjectsOfPersonWithSkillRequest {
	return SkillAPIGetProjectsOfPersonWithSkillRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *SkillAPIService) GetProjectsOfPersonWithSkillExecute(r SkillAPIGetProjectsOfPersonWithSkillRequest) (*PagedProjects, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.GetProjectsOfPersonWithSkill")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type SkillAPIReadPersonSkillStatisticsRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
	personId string
	skillId string
...
func (r SkillAPIReadPersonSkillStatisticsRequest) Execute() (*PersonSkillStatistic, *http.Response, error) {
...
ReadPersonSkillStatistics Show detailed statistics of a skill for a person
 ...
 @param personId
 @param skillId
 @return SkillAPIReadPersonSkillStatisticsRequest
*/
func (a *SkillAPIService) ReadPersonSkillStatistics(ctx context.Context, personId string, skillId string) SkillAPIReadPersonSkillStatisticsRequest {
	return SkillAPIReadPersonSkillStatisticsRequest{
		ApiService: a,
		ctx: ctx,
		personId: personId,
...
func (a *SkillAPIService) ReadPersonSkillStatisticsExecute(r SkillAPIReadPersonSkillStatisticsRequest) (*PersonSkillStatistic, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.ReadPersonSkillStatistics")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type SkillAPIRemoveSkillConfirmationRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
	projectParticipationId string
	skillId string
...
func (r SkillAPIRemoveSkillConfirmationRequest) Execute() (*ProjectParticipationDetails, *http.Response, error) {
...
RemoveSkillConfirmation Remove a confirmation
 ...
 @param skillId
 @param confirmingPersonId
 @return SkillAPIRemoveSkillConfirmationRequest
*/
func (a *SkillAPIService) RemoveSkillConfirmation(ctx context.Context, projectParticipationId string, skillId string, confirmingPersonId string) SkillAPIRemoveSkillConfirmationRequest {
	return SkillAPIRemoveSkillConfirmationRequest{
		ApiService: a,
		ctx: ctx,
		projectParticipationId: projectParticipationId,
...
// Execute executes the request
//  @return ProjectParticipationDetails
func (a *SkillAPIService) RemoveSkillConfirmationExecute(r SkillAPIRemoveSkillConfirmationRequest) (*ProjectParticipationDetails, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodDelete
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.RemoveSkillConfirmation")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type SkillAPISearchSkillsRequest struct {
	ctx context.Context
	ApiService *SkillAPIService
	skillSearch *SkillSearch
}

func (r SkillAPISearchSkillsRequest) SkillSearch(skillSearch SkillSearch) SkillAPISearchSkillsRequest {
	r.skillSearch = &skillSearch
	return r
}

func (r SkillAPISearchSkillsRequest) Execute() (*PagedSkills, *http.Response, error) {
	return r.ApiService.SearchSkillsExecute(r)
}

/*
SearchSkills Search over skills

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return SkillAPISearchSkillsRequest
*/
func (a *SkillAPIService) SearchSkills(ctx context.Context) SkillAPISearchSkillsRequest {
	return SkillAPISearchSkillsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return PagedSkills
func (a *SkillAPIService) SearchSkillsExecute(r SkillAPISearchSkillsRequest) (*PagedSkills, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SkillAPIService.SearchSkills")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/skills/search"
	...
	// body params
	localVarPostBody = r.skillSearch
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
